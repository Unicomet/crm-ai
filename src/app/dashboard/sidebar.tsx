...
function NavItem({
  ...
  return (
    <Link
      href={href}
      className={`animate-slide-in-left group flex items-center gap-3 rounded-lg px-3 py-2 text-sm transition-all duration-200 ${
        active
          ? "bg-honey-500/10 text-honey-400"
          : "text-noir-400 hover:bg-noir-800 hover:text-noir-200"
      }`}
    ...
    >
      ...
      {active && (
        <span className="bg-honey-500 ml-auto size-1.5 rounded-full" />
      )}
    </Link>
  );
}
...
export function Sidebar() {
  ...
  return (
    <aside className="border-noir-800/60 bg-noir-900/80 flex w-64 shrink-0 flex-col border-r backdrop-blur-xl">
      {/* Logo */}
      <div className="animate-fade-in flex items-center justify-between px-6 pt-7 pb-2">
        <div className="flex items-center gap-3">
          <div className="from-honey-500 to-honey-700 flex size-8 items-center justify-center rounded-lg bg-gradient-to-br">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
              className="text-noir-950 size-4"
            >
              <path d="M4.5 6.375a4.125 4.125 0 1 1 8.25 0 4.125 4.125 0 0 1-8.25 0ZM14.25 8.625a3.375 3.375 0 1 1 6.75 0 3.375 3.375 0 0 1-6.75 0ZM1.5 19.125a7.125 7.125 0 0 1 14.25 0v.003l-.001.119a.75.75 0 0 1-.363.63 13.067 13.067 0 0 1-6.761 1.873c-2.472 0-4.786-.684-6.76-1.873a.75.75 0 0 1-.364-.63l-.001-.122ZM17.25 19.128l-.001.144a2.25 2.25 0 0 1-.233.96 10.088 10.088 0 0 0 5.06-1.01.75.75 0 0 0 .42-.643 4.875 4.875 0 0 0-6.957-4.611 8.586 8.586 0 0 1 1.71 5.157v.003Z" />
            </svg>
          </div>
          <div>
            <h1 className="text-noir-100 font-serif text-lg leading-none tracking-tight">
              CRM
            </h1>
            <p className="text-honey-500/70 text-[10px] font-semibold tracking-[0.2em] uppercase">
              network
            </p>
          </div>
        </div>
      ...
      <nav className="mt-8 flex flex-1 flex-col gap-1 px-3">
        ...
        <div className="mt-6 mb-2 px-3">
          <p className="text-noir-500 text-[11px] font-semibold tracking-[0.15em] uppercase">
            Categories
          </p>
        </div>
        ...
        {categories.map((cat, i) => (
          <NavItem
            ...
            icon={cat.icon}
            label={cat.name}
            active={pathname === `/dashboard/category/${cat.slug}`}
            delay={140 + i * 50}
          />
        ))}
        ...
        {/* Bottom nav */}
        <div className="border-noir-800/60 border-t pt-3 pb-4">
          <NavItem
